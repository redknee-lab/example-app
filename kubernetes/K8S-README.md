...
```
$ docker image tag gateway lukethep/gateway
$ docker push lukethep/gateway
$ docker image tag invoice lukethep/invoice
$ docker push lukethep/invoice
$ docker image tag review lukethep/review
$ docker push lukethep/review
```
